  ...
  return (
    <div style={{ marginBottom: '32px' }}>
      <div className="section-header">
        <h2><HistoryIcon size={20} /> Continue Watching</h2>
        <button type="button" className="secondary-btn" onClick={() => navigate('/history')} style={{ fontSize: '0.8rem', padding: '6px 12px' }}>
          ...
          {historyPreview.map((entry) => {
            ...
            return (
              <button 
                ...
                type="button"
              >
                <div style={{ position: 'relative', width: '120px', aspectRatio: '16/9', borderRadius: '8px', overflow: 'hidden', flexShrink: 0 }}>
                  <img
                    src={entry.vod?.previewThumbnailURL || 'https://static-cdn.jtvnw.net/ttv-static/404_preview-320x180.jpg'}
                ...
                <div style={{ minWidth: 0, flex: 1 }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', marginTop: '4px', fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                    <span style={{ color: 'var(--text)', fontWeight: 600 }}>{entry.vod?.owner?.displayName || 'Unknown channel'}</span>
                    <span>•</span>
