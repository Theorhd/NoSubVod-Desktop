  ...
  return (
    <div style={{ marginBottom: '32px' }}>
      <div className="section-header">
        <h2><Users size={20} /> Your Channels</h2>
      </div>
      ...
      <div style={{ 
        ...
        {subs.length === 0 ? (
          <div className="card glass" style={{ width: '100%', textAlign: 'center', padding: '32px' }}>
            <div style={{ color: 'var(--text-muted)' }}>No channels followed yet.</div>
          </div>
        ) : (
          subs.map((sub) => {
              ...
              >
                <div style={{ position: 'relative' }}>
                  ...
                  {isLive && (
                    <span style={{ 
                      ...
                      background: 'var(--danger)', color: '#fff', fontSize: '0.6rem', fontWeight: 800,
                      padding: '2px 6px', borderRadius: '4px', boxShadow: '0 2px 8px rgba(255,107,135,0.4)',
                      zIndex: 2
                    }}>LIVE</span>
                  )}
                </div>
                ...
                <button
                  ...
                  style={{ 
                    ...
                    padding: 0, borderRadius: '50%', opacity: 0, transition: 'opacity 0.2s ease',
                    zIndex: 10
                  }}
                  onClick={(e) => {
                    e.stopPropagation();
